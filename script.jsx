  ...
  render: function(){
    ...
    switch(correct){
      ...
      default:
        ...
        button = (<button className = "btn btn-primary btn-lg" disabled = {disabled}
    ...
    return(
      <div id="button-frame">
        ...
        <span className = "glyphicon glyphicon-refresh"></span><br />
        {this.props.redraws}
        </button>
      </div>
      );
...
var AnswerFrame = React.createClass({
  render: function(){
    ...
    var selectedNumbers = props.selectedNumbers.map(function(num){
      return(<span onClick = {props.unselectNumber.bind(null,num)}>
        {num}
        </span>)
...
var Game = React.createClass({
  ...
  redraw: function(){
    ...
    this.setState({numberOfStars :this.randomNumber() , correct : null ,selectedNumbers:[],
  ...
  updateDoneStatus: function(){
    if(this.state.usedNumbers.length ===9){
      this.setState({doneStatus : "Well Done!! You WON"})
    }
    
    if(this.state.redraws === 0 && !this.possibleSolutions()){
      this.setState({doneStatus : "Sorry!! Game Over"})
    }
  },
  render: function(){
    var selectedNumbers = this.state.selectedNumbers;
